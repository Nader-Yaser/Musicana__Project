...
namespace Musicana.Api.Migrations
{
    ...
    [Migration("20260427175712_AddIdentity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Musicana.Api.Models.Album", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            IsDeleted = false,
                            MusicianId = 2,
                            ReleaseDate = new DateTime(2021, 6, 20, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Title = "Album 2"
                        },
                        new
                        {
                            ...
                            IsDeleted = false,
                            MusicianId = 1,
                            ReleaseDate = new DateTime(2022, 3, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Title = "Album 3"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("Musicana.Api.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Musicana.Api.Models.ApplicationUser", null)
                        .WithMany()
